//==============================================================================
/*
    bpsk_retake_manor_plot.nss
    This tracks the quest to rescapture Knife Edge Manor.
*/
//==============================================================================
    ...
    if(nType == EVENT_TYPE_SET_PLOT) // actions -> normal flags only
    {
        ...
        switch(nFlag)
        {
            case MANOR_QUEST_ACCEPTED:
            {
                ...
                {
//                    DisplayFloatyMessage(oPC,"Lothering gone - Manor.",FLOATY_MESSAGE,0xff0000,10.0);
                ...
                // Remove plot from Job Board
                WR_SetPlotFlag(PLT_BPSK_RETAKE_MANOR,MANOR_CHANTER_BOARD, FALSE);
                break;
            }
            ...
            {
                // Update parent plot also
                WR_SetPlotFlag(PLT_BP_SPIDERS_KNIVES,BPSK_MANOR_ENTERED,TRUE);
            ...
            {
                // Update parent plot also
                WR_SetPlotFlag(PLT_BP_SPIDERS_KNIVES,BPSK_MANOR_CLEARED,TRUE);

                break;
            }

            case MANOR_REWARD_GIVEN:
            {
                // Update parent plot also
                WR_SetPlotFlag(PLT_BP_SPIDERS_KNIVES,BPSK_REWARD_GIVEN,TRUE);

                // Clear the job board entry
                WR_SetPlotFlag(PLT_BPSK_RETAKE_MANOR,MANOR_CHANTER_BOARD,FALSE);
