...
void _ApplyImpact(struct EventSpellScriptImpactStruct stEvent)
{
	...
	// Following 2 lines edited by Archid to match description of Stronger Regenerating Burst in readme file
    float fHPRegen = 30.0 + 0.5 * fConMod + MaxF(0.0, (0.5 - fHPLvl) * 50.0); // basically means +1 for every 10% below 50%
    float fStamRegen = 20.0 + 0.25 * fConMod + MaxF(0.0, (0.5 - fStamLvl) * 25.0); // basically means +0.5 for every 10% below 50%
