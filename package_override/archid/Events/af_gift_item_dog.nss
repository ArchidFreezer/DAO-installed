    ...
    switch(nEventType) {
        case EVENT_TYPE_GIFT_ITEM: {
            ...
            if(!IsObjectValid(oGift)) {
                afLogWarn("Invalid item was gifted", AF_LOG_DOG_GIFTS);
                break;
            }
            ...
            if (sFollower == GEN_FL_DOG) {
                ...
                afLogInfo("Gift: " + sGiftTag, AF_LOG_DOG_GIFTS);
                if (sGiftTag == "gen_im_gift_dogbone") {
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Constitution", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Strength", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Attack", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Defence", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + "% Dodge Chance", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Willpower", AF_LOG_DOG_GIFTS);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Dexterity", AF_LOG_DOG_GIFTS);
