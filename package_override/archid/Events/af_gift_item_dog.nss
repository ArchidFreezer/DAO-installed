...
*
**/
const string LOG_GROUP = "DogGifts";
    ...
    switch(nEventType) {
        case EVENT_TYPE_GIFT_ITEM: {
            ...
            if(!IsObjectValid(oGift)) {
                afLogWarn("Invalid item was gifted", LOG_GROUP);
                break;
            }
            ...
            if (sFollower == GEN_FL_DOG) {
                ...
                afLogInfo("Gift: " + sGiftTag, LOG_GROUP);
                if (sGiftTag == "gen_im_gift_dogbone") {
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Constitution", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Strength", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Attack", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Defence", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + "% Dodge Chance", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Willpower", LOG_GROUP);
                    ...
                    afLogDebug("+" + FloatToString(fNewVal, 1, 0) + " Dexterity", LOG_GROUP);
