    ...
    switch(nEventType)
    {
        ...
        case EVENT_TYPE_SPELLSCRIPT_CAST:
        {
            ...
            // Make sure using the potion or book
                   ...
                   if (IsHero(oUser))
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, PLAYER_HELMET) == TRUE )
                   ...
                   if (sUser=="Alistair")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, ALISTAIR_HELMET) == TRUE )
                   ...
                   if (sUser=="Leliana")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, LELIANA_HELMET) == TRUE )
                   ...
                   if (sUser=="Loghain")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, LOGHAIN_HELMET) == TRUE )
                   ...
                   if (sUser=="Morrigan")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, MORRIGAN_HELMET) == TRUE )
                   ...
                   if (sUser=="Oghren")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, OGHREN_HELMET) == TRUE )
                   ...
                   if (sUser=="Sten")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, STEN_HELMET) == TRUE )
                   ...
                   if (sUser=="Wynne")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, WYNNE_HELMET) == TRUE )
                   ...
                   if (sUser=="Zevran")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, ZEVRAN_HELMET) == TRUE )
                   ...
                   if (sUser=="Anders")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, ANDERS_HELMET) == TRUE )
                   ...
                   if (sUser=="Velanna")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, VELANNA_HELMET) == TRUE )
                   ...
                   if (sUser=="Sigrun")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, SIGRUN_HELMET) == TRUE )
                   ...
                   if (sUser=="Mhairi")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, MHAIRI_HELMET) == TRUE )
                   ...
                   if (sUser=="Nathaniel")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, NATHANIEL_HELMET) == TRUE )
                   ...
                   if (sUser=="Justice")
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, JUSTICE_HELMET) == TRUE )
                   ...
                   {  if (WR_GetPlotFlag( PLT_AF_NOHELMET, UNKNOWN_HELMET) == TRUE )
