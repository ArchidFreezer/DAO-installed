...
const int AF_LOGGROUP_NOHELMET = 1;
...
void NoHelmetShowInventory() {
    afLogDebug("Showing inventory", AF_LOGGROUP_NOHELMET);
...
void NoHelmetItemSetUpdate(object oCreature) {
    ...
    afLogInfo("Item set update", AF_LOGGROUP_NOHELMET);
    ...
    afLogDebug("nSlotArray = " + ToString(nSlotArray), AF_LOGGROUP_NOHELMET);
...
void NoHelmetLeaveGUI() {
    afLogDebug("Leaving GUI", AF_LOGGROUP_NOHELMET);
