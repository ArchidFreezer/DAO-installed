...
void main()
{
    ...
    object oVendor      = UT_GetNearestObjectByTag(oCharacter, "wrk_respec_vendor_npc");
    ...
    if (!IsObjectValid(oVendor))
    {
        ...
        if ( FindSubString( sLocationTag, "pre100ar_kings_camp", 0 ) >= 0 )
        {
            ...
            object oTest    = CreateObject(OBJECT_TYPE_CREATURE, R"wrk_respec_vendor_npc.utc", lSpawn);
        }
        ...
        else if ( sLocationTag == "arl100ar_redcliffe_village" ||
                  sLocationTag == "arl101ar_redcliffe_night" )
        {
        ...
        else if ( FindSubString( sLocationTag, "ar_camp_", 0 ) >= 0 )
        {
            ...
            CreateObject(OBJECT_TYPE_CREATURE, R"wrk_respec_vendor_npc.utc", lSpawn);
        }
    }
}